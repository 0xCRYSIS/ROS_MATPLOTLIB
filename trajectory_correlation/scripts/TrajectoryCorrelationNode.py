...
class TrajectoryCorrelation:
    ...
    def vo_callback(self,msg):
        ...
        self.vo_x.append(msg.pose.pose.position.x)
        self.vo_y.append(msg.pose.pose.position.y)
    
    def animation(self,i):
        plt.cla()
        plt.plot(self.vo_x,self.vo_y,label="VO")
        plt.legend()
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ani = FuncAnimation(plt.gcf(),TC_Node.animation)
